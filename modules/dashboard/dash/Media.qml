...
Item {
    ...
    StyledText {
        ...
        text: (Players.active?.trackTitle ?? qsTr("Không có nội dung")) || qsTr("Không rõ tiêu đề")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackAlbum ?? qsTr("Không có nội dung")) || qsTr("Không rõ album")
    ...
    StyledText {
        ...
        animate: true
        horizontalAlignment: Text.AlignHCenter
        text: (Players.active?.trackArtist ?? qsTr("Không có nội dung")) || qsTr("Không rõ nghệ sĩ")
