...
StyledRect {
    ...
    Component.onCompleted: {
        // ListView clears the delegate's modelData role before the remove
        // animation finishes. Keep this locked NotifData reference stable so
        // bindings do not briefly dereference null during that animation.
                ...
                sourceComponent: StyledRect {
                    ...
                    Loader {
                        ...
                        sourceComponent: MaterialIcon {
                            text: Icons.getNotifIcon(root.modelData?.summary ?? "", root.modelData?.urgency ?? NotificationUrgency.Normal)
