...
ColumnLayout {
    ...
    StyledText {
        ...
        Layout.alignment: Qt.AlignHCenter
        animate: true
        text: qsTr("Cảm giác như %1").arg(Weather.temp)
        color: Colours.palette.m3onSurfaceVariant
        font: Tokens.font.body.large
    }
    ...
    StyledText {
        ...
        text: {
            ...
            return qsTr("Cao nhất %1 • Thấp nhất %2").arg(Weather.formatTemp(today?.maxTempC)).arg(Weather.formatTemp(today?.minTempC));
        }
        color: Colours.palette.m3onSurfaceVariant
