        ...
        Repeater {
            ...
            ColumnLayout {
                ...
                StyledText {
                    ...
                    Layout.alignment: Qt.AlignHCenter
                    text: hour.index === 0 ? qsTr("Bây giờ") : Qt.formatDateTime(new Date(hour.cond.timestamp.replace("T", " ")), GlobalConfig.services.useTwelveHourClock ? "ha" : "hh:00")
