...
ColumnLayout {
    ...
    StyledText {
        ...
        text: Notifs.list.length > 0 ? qsTr("%1 thông báo%2").arg(Notifs.list.length).arg("") : qsTr("Thông báo")
        ...
        Loader {
            ...
            sourceComponent: ColumnLayout {
                ...
                StyledText {
                    ...
                    text: Config.lock.hideNotifs ? qsTr("Mở khóa để xem thông báo") : qsTr("Không có thông báo")
