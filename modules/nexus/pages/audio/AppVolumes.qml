...
PageBase {
    ...
    ColumnLayout {
        ...
        StyledText {
            ...
            text: qsTr("Điều chỉnh âm lượng của từng ứng dụng đang phát âm thanh.")
        ...
        ItemList {
            ...
            placeholderText: qsTr("Không có ứng dụng nào đang phát âm thanh")
