...
StyledRect {
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            StyledText {
                Layout.fillWidth: true
                text: IdleInhibitor.enabled ? qsTr("Đang ngăn chế độ ngủ") : qsTr("Quản lý nguồn bình thường")
    ...
    Loader {
        ...
        sourceComponent: StyledRect {
            ...
            StyledText {
                ...
                anchors.centerIn: parent
                text: qsTr("Hoạt động từ %1").arg(Qt.formatTime(IdleInhibitor.enabledSince, GlobalConfig.services.useTwelveHourClock ? "hh:mm a" : "hh:mm"))
